...
namespace hpl {
	...
	cLowLevelGraphicsOpenGL::cLowLevelGraphicsOpenGL()
	{
	...
	bool cLowLevelGraphicsOpenGL::Init(int alWidth, int alHeight, int alDisplay, int alBpp, int abFullscreen, 
	...
	void cLowLevelGraphicsOpenGL::CheckMultisampleCaps()
	{
	...
	void cLowLevelGraphicsOpenGL::SetupGL()
	{
		///////////////////////////////
		// Setup variables
	...
	int cLowLevelGraphicsOpenGL::GetCaps(eGraphicCaps aType)
	{
		;
	...
	iFontData* cLowLevelGraphicsOpenGL::CreateFontData(const tString &asName)
	{
		;
	...
	iGpuProgram* cLowLevelGraphicsOpenGL::CreateGpuProgram(const tString& asName)
	{
		;
	...
	iGpuShader* cLowLevelGraphicsOpenGL::CreateGpuShader(const tString& asName, eGpuShaderType aType)
	{
		;
	...
	iTexture* cLowLevelGraphicsOpenGL::CreateTexture(const tString &asName,eTextureType aType,   eTextureUsage aUsage)
	{
		;

		cTextureGL *pTexture = hplNew( cTextureGL, (asName,aType, aUsage, this) );
	...
	iVertexBuffer* cLowLevelGraphicsOpenGL::CreateVertexBuffer(eVertexBufferType aType,
	...
	iFrameBuffer* cLowLevelGraphicsOpenGL::CreateFrameBuffer(const tString& asName)
	{
		;
	...
	iDepthStencilBuffer* cLowLevelGraphicsOpenGL::CreateDepthStencilBuffer(const cVector2l& avSize, int alDepthBits, int alStencilBits)
	{
		;
	...
	iOcclusionQuery* cLowLevelGraphicsOpenGL::CreateOcclusionQuery()
	{
		;
	...
	void cLowLevelGraphicsOpenGL::ClearFrameBuffer(tClearFrameBufferFlag aFlags)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetClearColor(const cColor& aCol){
		;

		glClearColor(aCol.r, aCol.g, aCol.b, aCol.a);
	}
	void cLowLevelGraphicsOpenGL::SetClearDepth(float afDepth){
		;

		glClearDepth(afDepth);
	}
	void cLowLevelGraphicsOpenGL::SetClearStencil(int alVal){
		;
	...
	void cLowLevelGraphicsOpenGL::CopyFrameBufferToTexure(iTexture* apTex, const cVector2l &avPos, 
	...
	cBitmap* cLowLevelGraphicsOpenGL::CopyFrameBufferToBitmap(	const cVector2l &avScreenPos,const cVector2l &avScreenSize)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetCurrentFrameBuffer(iFrameBuffer* apFrameBuffer, const cVector2l &avPos, const cVector2l& avSize)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetFrameBufferDrawTargets(int *apTargets, int alNumOfTargets)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::WaitAndFinishRendering()
	{
		;
	...
	void cLowLevelGraphicsOpenGL::FlushRendering()
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SwapBuffers()
	{
		;
        SDL_GL_SwapWindow(mpScreen);
	}
	...
	void cLowLevelGraphicsOpenGL::SetColorWriteActive(bool abR,bool abG,bool abB,bool abA)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetDepthWriteActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetDepthTestActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetDepthTestFunc(eDepthTestFunc aFunc)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetAlphaTestActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetAlphaTestFunc(eAlphaTestFunc aFunc,float afRef)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetStencilActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetStencilWriteMask(unsigned int alMask)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetStencil(eStencilFunc aFunc,int alRef, unsigned int aMask,
	...
	void cLowLevelGraphicsOpenGL::SetStencilTwoSide(eStencilFunc aFrontFunc,eStencilFunc aBackFunc,
	...
	void cLowLevelGraphicsOpenGL::SetCullActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetCullMode(eCullMode aMode)
	{
	...
	void cLowLevelGraphicsOpenGL::SetScissorActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetScissorRect(const cVector2l& avPos, const cVector2l& avSize)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetClipPlane(int alIdx, const cPlanef& aPlane)
	{
		;
	...
	cPlanef cLowLevelGraphicsOpenGL::GetClipPlane(int alIdx)
	{
		;

		return mvClipPlanes[alIdx];
	}
	void cLowLevelGraphicsOpenGL::SetClipPlaneActive(int alIdx, bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetBlendActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetBlendFunc(eBlendFunc aSrcFactor, eBlendFunc aDestFactor)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetBlendFuncSeparate(eBlendFunc aSrcFactorColor, eBlendFunc aDestFactorColor,
	...
	void cLowLevelGraphicsOpenGL::SetPolygonOffsetActive(bool abX)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetPolygonOffset(float afBias, float afSlopeScaleBias)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::PushMatrix(eMatrix aMtxType)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::PopMatrix(eMatrix aMtxType)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetMatrix(eMatrix aMtxType, const cMatrixf& a_mtxA)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetIdentityMatrix(eMatrix aMtxType)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetOrthoProjection(const cVector2f& avSize, float afMin, float afMax)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetOrthoProjection(const cVector3f& avMin, const cVector3f& avMax)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetTexture(unsigned int alUnit,iTexture* apTex)
	{
		;
		...
		else
		{
			...
			cTextureGL *pSDLTex = static_cast<cTextureGL*> (apTex);
	...
	void cLowLevelGraphicsOpenGL::SetActiveTextureUnit(unsigned int alUnit)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetTextureEnv(eTextureParam aParam, int alVal)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetTextureConstantColor(const cColor &aColor)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetColor(const cColor &aColor)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawTriangle(tVertexVec& avVtx)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawQuad(const cVector3f &avPos,const cVector2f &avSize,const cColor& aColor)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawQuad(const cVector3f &avPos,const cVector2f &avSize,
	...
	void cLowLevelGraphicsOpenGL::DrawQuad(const tVertexVec &avVtx)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawQuadMultiTex(const tVertexVec &avVtx,const tVector3fVec &avExtraUvs)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawQuad(const tVertexVec &avVtx, const cColor aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawQuad(const tVertexVec &avVtx,const float afZ)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawQuad(const tVertexVec &avVtx,const float afZ,const cColor &aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawLine(const cVector3f& avBegin, const cVector3f& avEnd, cColor aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawLine(const cVector3f& avBegin, const cColor& aBeginCol, const cVector3f& avEnd, const cColor& aEndCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawBoxMinMax(const cVector3f& avMin, const cVector3f& avMax, cColor aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawSphere(const cVector3f& avPos, float afRadius, cColor aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawSphere(const cVector3f& avPos, float afRadius, cColor aColX, cColor aColY, cColor aColZ)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawLineQuad(const cRect2f& aRect, float afZ, cColor aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::DrawLineQuad(const cVector3f &avPos,const cVector2f &avSize, cColor aCol)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::AddVertexToBatch(const cVertex *apVtx)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::AddVertexToBatch(const cVertex *apVtx, const cVector3f* avTransform)
	{
		;
		if(mlVertexCount/mlBatchStride >= mlBatchArraySize)
		{
	...
	void cLowLevelGraphicsOpenGL::AddVertexToBatch(const cVertex *apVtx, const cMatrixf* aMtx)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::AddVertexToBatch_Size2D(const cVertex *apVtx, const cVector3f* avTransform,
	...
	void cLowLevelGraphicsOpenGL::AddVertexToBatch_Raw(	const cVector3f& avPos, const cColor &aColor,
	...
	void cLowLevelGraphicsOpenGL::AddIndexToBatch(int alIndex)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::AddTexCoordToBatch(unsigned int alUnit,const cVector3f *apCoord)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetBatchTextureUnitActive(unsigned int alUnit,bool abActive)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::FlushTriBatch(tVtxBatchFlag aTypeFlags, bool abAutoClear)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::FlushQuadBatch(tVtxBatchFlag aTypeFlags, bool abAutoClear)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::ClearBatch()
	{
		mlIndexCount = 0;
		mlVertexCount = 0;
	}
	...
	void cLowLevelGraphicsOpenGL::SetUpBatchArrays()
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetVtxBatchStates(tVtxBatchFlag aFlags)
	{
		;
	...
	void cLowLevelGraphicsOpenGL::SetMatrixMode(eMatrix mType)
	{
		;
